...
local function UpdateHitbox()
    for _, player in ipairs(Players:GetPlayers()) do
        ...
        local part = char:FindFirstChild(Config.HitboxPart) or char:FindFirstChild("Head")
        ...
        if Config.HitboxESP and Config.HitboxEnabled then
            if not HitboxHighlights[player] or HitboxHighlights[player].Parent ~= char then
                if HitboxHighlights[player] then
                    HitboxHighlights[player]:Destroy()
                end
                ...
                HitboxHighlights[player].FillColor = Config.HitboxColor
                HitboxHighlights[player].OutlineColor = Config.HitboxColor
            end
        else
            if HitboxHighlights[player] then
                HitboxHighlights[player]:Destroy()
...
local function CleanupHitbox()
    ...
    for player, originalSize in pairs(OriginalHitboxSizes) do
        if player.Character then
            local part = player.Character:FindFirstChild(Config.HitboxPart) or player.Character:FindFirstChild("Head")
